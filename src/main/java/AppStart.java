...
public class AppStart extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        //for (int i = 0; i < 30; i++) {
            base = new BaseImage("C:\\Users\\felix\\IdeaProjects\\nNearest\\src\\main\\resources\\DSC_3462.JPG", 1280, 720);
            float[][][] imgArray = base.preSize;
            float[][] centers = null;
            imgArray = NNearestN.cluster(imgArray, 20, 5, imgArray.length, imgArray[0].length, 0, true, 0.1f, false);
        ...
        cAni.saveAnimation("C:\\Users\\felix\\IdeaProjects\\nNearest\\processedImg\\", "drawing", imgArray, 20, 2000, 30, 1280, 720, centers);
