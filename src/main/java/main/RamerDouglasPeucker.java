...
public class RamerDouglasPeucker {
    ...
    private static final void douglasPeucker(ArrayList<double[]> list, int s, int e, double epsilon, List<double[]> resultList) {
     ...
     */
    public static final ArrayList<double[]> douglasPeucker(ArrayList<double[]> list, double epsilon) {
        final ArrayList<double[]> resultList = new ArrayList<double[]>();
